...
import com.jmr.mcx.handler.CustomLogoutHandler;
import com.jmr.mcx.handler.CustomLogoutSuccessHandler;
/***
 * @author JMR
 */
...
System.out.println("--------------http security-----------------------");
	...
	public void configure(WebSecurity webSecurity) throws Exception {
		webSecurity.ignoring().antMatchers("/fonts/**", "/js/**", "/images/**", "/css/**", "/plugins/**", "/dist/**","/app/**");
	}
