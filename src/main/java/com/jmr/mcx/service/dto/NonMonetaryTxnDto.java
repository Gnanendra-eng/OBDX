...
public class NonMonetaryTxnDto {
	...
	public NonMonetaryTxnDto(){
		  
	}
	  
	  
	  
	public NonMonetaryTxnDto(int id, String payye_name, String account_name, String branch_code, String nick_name,
			String account_number, String is_active, Date registration_date_time, int ref_user_id, String swift_code,
			String ncc, int ref_transfer_type_id, int ref_transfer_via_type_id,String email, Long phone_numbr,Long avail_balance, String bank_name) {
		super();
		this.id = id;
