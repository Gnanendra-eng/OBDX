...
public class BeneficiaryDto {
	...
	public BeneficiaryDto(String payeeName, String accountName, String accountNumber, String branchId, String bankName,
			String city, String bankAddr) {
		super();
		this.payeeName = payeeName;
		this.accountName = accountName;
		this.accountNumber = accountNumber;
	...
	public BeneficiaryDto(long id, String payeeName, String accountName, String accountNumber, String branchId, String bankName,
			String city, String bankAddr) {
		super();
		this.id = id;
		this.payeeName = payeeName;
