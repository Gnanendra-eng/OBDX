...
/**
 * MstchanneluserId generated by hbm2java
 */
@Embeddable
public class MstchanneluserId  implements java.io.Serializable {


     private String iduser;
     private String idchannel;

    public MstchanneluserId() {
    }

    public MstchanneluserId(String iduser, String idchannel) {
       this.iduser = iduser;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof MstchanneluserId) ) return false;
		 MstchanneluserId castOther = ( MstchanneluserId ) other; 
