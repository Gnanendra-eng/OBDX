...
/**
 * EntityLevelLimitsEffectiveId generated by hbm2java
 */
@Embeddable
public class EntityLevelLimitsEffectiveId  implements java.io.Serializable {
    ...
    public EntityLevelLimitsEffectiveId() {
    }

    public EntityLevelLimitsEffectiveId(String idEntity, String typeuser, String idchannel, String idtxn) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof EntityLevelLimitsEffectiveId) ) return false;
		 EntityLevelLimitsEffectiveId castOther = ( EntityLevelLimitsEffectiveId ) other; 
