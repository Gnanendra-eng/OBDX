...
/**
 * MstruleparameterId generated by hbm2java
 */
@Embeddable
public class MstruleparameterId  implements java.io.Serializable {
    ...
    public MstruleparameterId() {
    }

    public MstruleparameterId(String idapp, String idrule, byte idindex) {
       this.idapp = idapp;
       this.idrule = idrule;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof MstruleparameterId) ) return false;
		 MstruleparameterId castOther = ( MstruleparameterId ) other; 
