...
/**
 * MstchannelatsId generated by hbm2java
 */
@Embeddable
public class MstchannelatsId  implements java.io.Serializable {
    ...
    public MstchannelatsId() {
    }

    public MstchannelatsId(String idrequest, String idchannel, String idtxn) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof MstchannelatsId) ) return false;
		 MstchannelatsId castOther = ( MstchannelatsId ) other; 
