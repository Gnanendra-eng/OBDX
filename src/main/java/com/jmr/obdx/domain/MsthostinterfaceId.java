...
/**
 * MsthostinterfaceId generated by hbm2java
 */
@Embeddable
public class MsthostinterfaceId  implements java.io.Serializable {
    ...
    public MsthostinterfaceId() {
    }

    public MsthostinterfaceId(String idEntity, String idrequest, String idhost, BigDecimal version) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof MsthostinterfaceId) ) return false;
		 MsthostinterfaceId castOther = ( MsthostinterfaceId ) other; 
