...
/**
 * IsOrderstatusinquirydetailsId generated by hbm2java
 */
@Embeddable
public class IsOrderstatusinquirydetailsId  implements java.io.Serializable {
    ...
    public IsOrderstatusinquirydetailsId() {
    }

    public IsOrderstatusinquirydetailsId(String idEntity, String txnnumber, String idfund, String idcust, String iduh) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof IsOrderstatusinquirydetailsId) ) return false;
		 IsOrderstatusinquirydetailsId castOther = ( IsOrderstatusinquirydetailsId ) other; 
