...
/**
 * MstusertypetxnId generated by hbm2java
 */
@Embeddable
public class MstusertypetxnId  implements java.io.Serializable {
    ...
    public MstusertypetxnId() {
    }

    public MstusertypetxnId(String idEntity, String usertype, String idchannel, String idtxn) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof MstusertypetxnId) ) return false;
		 MstusertypetxnId castOther = ( MstusertypetxnId ) other; 
