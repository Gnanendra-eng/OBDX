...
/**
 * EntityLevelLimitsId generated by hbm2java
 */
@Embeddable
public class EntityLevelLimitsId  implements java.io.Serializable {
    ...
    public EntityLevelLimitsId() {
    }

    public EntityLevelLimitsId(String idEntity, String typeuser, String idchannel, String idtxn) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof EntityLevelLimitsId) ) return false;
		 EntityLevelLimitsId castOther = ( EntityLevelLimitsId ) other; 
