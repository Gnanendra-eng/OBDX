...
/**
 * IsMstfundcurrId generated by hbm2java
 */
@Embeddable
public class IsMstfundcurrId  implements java.io.Serializable {
    ...
    public IsMstfundcurrId() {
    }

    public IsMstfundcurrId(String idEntity, String idfund, String codcurrtxn, String txntype) {
    ...
    @Column(name="CODCURRTXN", nullable=false, length=3)
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof IsMstfundcurrId) ) return false;
		 IsMstfundcurrId castOther = ( IsMstfundcurrId ) other; 
 ...
 && ( (this.getCodcurrtxn()==castOther.getCodcurrtxn()) || ( this.getCodcurrtxn()!=null && castOther.getCodcurrtxn()!=null && this.getCodcurrtxn().equals(castOther.getCodcurrtxn()) ) )
 && ( (this.getTxntype()==castOther.getTxntype()) || ( this.getTxntype()!=null && castOther.getTxntype()!=null && this.getTxntype().equals(castOther.getTxntype()) ) );
   ...
   public int hashCode() {
         ...
         result = 37 * result + ( getCodcurrtxn() == null ? 0 : this.getCodcurrtxn().hashCode() );
